...
class CMACGM(DCSA):
    ...
    def __init__(self, client_id: str, client_secret: str, token_url: str, api_key: str):
    ...
    def make_request(self, url: str, params: Dict[str, Any], scope) -> Dict[str, Any]:
    ...
    def track_and_trace(
        ...
        try:
            data = self.make_request(settings.CMA_CGM_TRACK_AND_TRACE_URL, params, "tandtcommercial:read:be")
            return data
    ...
    def bill_of_landing(self, transportDocumentReference: str) -> Dict[str, Any]:
        try:
            ...
            data = self.make_request(settings.CMA_CGM_SHIPEMENTS_URL + f"/{transportDocumentReference}", {}, "bldraft:read:be")
            return data
        except requests.HTTPError as http_err:
            print(f"HTTP error occurred: {http_err}")
        except Exception as err:
